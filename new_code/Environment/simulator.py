...
class Simulator:
    ...
    def __init__(self, config_file=0):
        ...
        self.u1 = UserClass(
            ...
            cf.min_daily_users_F,
            cf.max_daily_users_F,
            cf.alphas_F,
            cf.sold_items_F,
            cf.graph_proba_F
        )
        ...
        self.u2 = UserClass(
            ...
            cf.min_daily_users_S,
            cf.max_daily_users_S,
            cf.alphas_S,
            cf.sold_items_S,
            cf.graph_proba_S
        )
        ...
        self.u3 = UserClass(
            ...
            cf.min_daily_users_M,
            cf.max_daily_users_M,
            cf.alphas_M,
            cf.sold_items_M,
            cf.graph_proba_M
        )
    ...
    def simulate(self, price_conf, users=None, cl_number = -1):
        ...
        for cl_id, cl in enumerate(self.user_classes):
            ...
            for i in range(daily_users):
                ...
                prob_matrix = cl.graph_proba.copy() * self.lam
