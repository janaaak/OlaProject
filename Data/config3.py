...
conversion_rates_S = np.array([[0.92, 0.85, 0.78, 0.67],
                               ...
                               [0.7 , 0.65, 0.6 , 0.55],
                               [0.53, 0.41, 0.35, 0.27]])
conversion_rates_S = 0.6*conversion_rates_S
#Male adults
conversion_rates_M = np.array([[0.2 , 0.15, 0.1 , 0.05],
                               ...
                               [0.69, 0.6 , 0.53, 0.45],
                               [0.95, 0.83, 0.77, 0.7 ]])
conversion_rates_M = 0.6*conversion_rates_M
#Female adults
conversion_rates_F = np.array([[0.2 , 0.15, 0.1 , 0.05],
                               ...
                               [0.51, 0.45, 0.34, 0.22],
                               [0.23, 0.16, 0.11, 0.05]])
conversion_rates_F = 0.6*conversion_rates_F

cr_mean = (conversion_rates_S+conversion_rates_M+conversion_rates_F)/3


prices = np.array([[7, 8.4, 11.2, 11.9],
                   [68.6, 74.2, 82.6, 89.6],
                   [11.2, 15.4, 18.2, 23.8],
                   [40.6, 50.4, 70, 77],
                   [46.2, 53.2, 63, 68.6]])
